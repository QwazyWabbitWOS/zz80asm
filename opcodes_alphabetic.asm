...
;	SLL	r	;Shift logical left register r (sets bit 0)
	...
	SLL   (IX + DD),B	;Shift left logical at loctation (IX + DD) and store in register
	SLL   (IX + DD),C	;Equivalent: LD r, (2*(IX+DD))+1
	SLL   (IX + DD),D
	SLL   (IX + DD),E
	SLL   (IX + DD),H
	SLL   (IX + DD),L
